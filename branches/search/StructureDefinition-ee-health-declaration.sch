...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:QuestionnaireResponse">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/hdecl/StructureDefinition/ee-health-declaration-category']) &gt;= 1">extension with URL = 'https://fhir.ee/hdecl/StructureDefinition/ee-health-declaration-category': minimum cardinality of 'extension' is 1</sch:assert>
